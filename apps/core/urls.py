...
from . import views
from apps.blogs.views import ListUserBookmarksView, ListUserPostsView, ListUserCommentsView
...
urlpatterns = [
    ...
    path('users/<int:id>/comments/', ListUserCommentsView.as_view(), name='user-comments'),
